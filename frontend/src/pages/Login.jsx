    ...
    <div className="min-h-screen bg-[#F3F8F9] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-md p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" name="password" value={form.password} onChange={handleChange} required className={inputClass} placeholder="Your password" />
            </div>
            <button
              type="submit"
              disabled={loading}
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          <Link to="/privacy-policy" className="hover:text-[#91BE4D] transition-colors">Privacy Policy</Link>
          <span className="mx-2">·</span>
          <Link to="/terms" className="hover:text-[#91BE4D] transition-colors">Terms of Service</Link>
        </p>
      </div>
    </div>
  );
