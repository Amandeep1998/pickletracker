...
const AUTOMATION_ROWS = [
  ...
  },
  {
    ...
    trigger: 'Daily · ~19:00 user local time',
    purpose: 'Day-before tournament reminder — push to subscribed users with tournaments tomorrow',
    job: 'pushReminder',
    channel: 'Web Push',
  },
  {
    ...
    badge: 'Nudge',
    badgeColor: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    trigger: 'Daily · ~23:30 user local time',
    purpose: 'Evening result prompt — nudges users who played a tournament yesterday but haven\'t logged results',
    job: 'pushReminder',
    channel: 'Web Push',
  },
  {
    ...
    trigger: 'Real-time · on tournament create',
    purpose: 'Community activity — notifies all other subscribed users when someone logs a tournament (max 1 per user per day)',
    job: 'tournamentActivityNotifier',
    channel: 'Web Push',
  },
  {
    type: 'Email',
    ...
    trigger: 'Real-time · on tournament create',
    purpose: 'Community activity — emails all users with reminders enabled when someone logs a tournament (max 1 per user per day)',
    job: 'tournamentActivityNotifier',
    channel: 'Resend',
  },
];
