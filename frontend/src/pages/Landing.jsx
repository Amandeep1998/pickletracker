      ...
      <header className="bg-white sticky top-0 z-20 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 flex-shrink-0">
            <img src="/brand-logo.png" alt="PickleTracker" className="h-10 w-auto object-contain" />
          </Link>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12">
          <div className="flex flex-col sm:flex-row justify-between gap-10">
            ...
            <div className="max-w-xs">
              <img src="/brand-logo.png" alt="PickleTracker" className="h-9 w-auto object-contain mb-4 opacity-90"/>
